"""
    Parse CSV Files with datapoints associated with multiple sensors and multiple parameters
...
def parse_data(raw_data, sensors_data, streams_data, config, datapoint_client):
    """Parse all the Data"""
